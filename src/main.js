...
import {generateCards, generateDetailsOfFilm} from './mock/card.js';
import {fillFilmDetails} from './mock/popup';
...
document
  ...
  .forEach((filmCardDescriptionEl) => {
    ...
    let cutDescription = filmCardDescription.substring(0, 140);
